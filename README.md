BudCoin
=======
BudCoin (BuC) - a 'faster' version of Litecoin which also uses scrypt
as a proof of work scheme and is intended for microtransactions.
 - 15 seconds block targets: beat that Litecoin! ;)
 - 219 842 007 680 total coins
...
So actually, this 'new' coin exists for the following reasons:
 - BuC proves that really anyone(!) can start a Litecoin/Bitcoin based currency
...
Finally, I only tested the command line server/tool 'budcoin' for the
